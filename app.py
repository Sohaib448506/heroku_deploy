from flask import Flask, make_response, request, g, abort,jsonify
import os
...
class Config():
    SQLALCHEMY_DATABASE_URI = os.environ.get("SQLALCHEMY_DATABASE_URI", 'sqlite:///basic_app.sqlite')
...
def test():
    ...
    if request.method == "GET":
        datathing=User.query.all()
        return jsonify([*map(convert, datathing)])
